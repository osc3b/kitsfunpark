package com.minecraftfunpark.kits.api;

import com.connorlinfoot.bountifulapi.BountifulAPI;
import com.minecraftfunpark.kits.Kits;
import com.minecraftfunpark.kits.api.events.PlayerSpawnKitEvent;
...
public class KitManager {
    ...
    public void spawnKit(Player player, Kit kit, long delay, boolean clear, boolean overwrite, boolean announce) {
        ...
        if (event.getAnnounce()) {
            player.sendMessage(Message.show("", "Kit " + kit.getName() + " spawneado.", MessageType.INFO));
            BountifulAPI.sendTitle(player,20,80,20,"","Kit " + kit.getName() + " spawneado");
            BountifulAPI.sendActionBar(player,"Kit " + kit.getName() + " spawneado", 100);
        }
